...
namespace H2020.IPMDecisions.IDP.BLL.ScheduleTasks
{
    public class HangfireJobScheduler
    {
        public static void HangfireScheduleJobs(IConfiguration configuration)
        {
            ...
            RecurringJob.RemoveIfExists(string.Format("Send Initial Inactive Email After {0} Months", firstEmail));
            ...
            RecurringJob.RemoveIfExists(string.Format("Send Second Inactive Email After {0} Months", secondEmail));
            ...
            RecurringJob.RemoveIfExists(string.Format("Send Last Inactive Email After {0} Months", lastEmail));
            ...
            RecurringJob.RemoveIfExists(string.Format("Remove Inactive User After {0} Months", deleteAccount));
