...
```Console
docker build --rm --pull -f ".\H2020.IPMDecisions.IDP.API\Docker\Dockerfile" -t "h2020.ipmdecisions.identityproviderservice:latest" --build-arg URL_PORT=5000 --build-arg BUILDER_VERSION=0.0.1 .
